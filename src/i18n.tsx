...
const enTranslations: Translations = {
  "ERR_OTP_RATE_LIMITED": "Please wait 60 seconds before requesting a new OTP.",
  "ERR_OTP_INVALID": "Invalid or expired OTP",
  "ERR_OTP_MAX_ATTEMPTS": "Maximum attempts reached. Please request a new OTP.",
  ...
  "doc.repo.title": "Document Repository",
  "doc.repo.subtitle": "Versioned, tamper-evident document storage with signature-status tracking.",
  "doc.uploadDocument": "Upload Document",
  "doc.documentId": "Document ID",
  "doc.title": "Title",
  "doc.actions": "Actions",
  "doc.verifyIntegrity": "Verify Integrity",
  "doc.integrityVerified": "Integrity Verified",
  "doc.integrityFailed": "Integrity Failed",
  "doc.signatureStatus": "Signature Status",
  "doc.versionHistory": "Version History",
  "doc.uploadFailed": "Upload Failed",
  "doc.unauthorized": "Unauthorized",
  "doc.archive": "Archive",
  "doc.search": "Search",
  "doc.filter": "Filter",
  "doc.documentInfo": "Document Info",
  "doc.uploadedAt": "Uploaded At",
  "doc.sha256": "SHA-256 Checksum",
  "doc.linkages": "Linkages",
  "doc.project": "Project",
  "doc.parcel": "Parcel",
  "doc.ulpin": "ULPIN",
  "doc.rnrCase": "R&R Case",
  "doc.compensation": "Compensation",
  "doc.statusAndVerification": "Status & Verification",
  "doc.integrityStatus": "Integrity Status",
  "doc.tamperingDetected": "The physical file hash does not match the database record. Tampering detected.",
  "doc.digitalSignature": "Digital Signature",
  "doc.cryptoSignatureUnavailable": "Cryptographically Verified Digital Signature unavailable in prototype. (Runtime/demo persistence)",
  "doc.downloadFile": "Download File",
  "doc.previewBrowser": "Preview (Browser)",
  "doc.uploadNewVersion": "Upload New Version",
  "doc.current": "Current",
  "doc.noOlderVersions": "No older versions.",
  "doc.selectFile": "Select a file to upload",
  "doc.chooseFile": "Choose File",
  "doc.titleRequired": "Title *",
  "doc.typeRequired": "Type *",
  "doc.projectIdRequired": "Project ID *",
  "doc.parcelIdOptional": "Parcel ID (Optional)",
  "doc.ulpinOptional": "ULPIN (Optional)",
  "doc.remarksOptional": "Remarks (Optional)",
  "doc.submitUpload": "Submit Upload",
  "doc.allTypes": "All Types",
  "doc.allStatuses": "All Statuses",
  "doc.type.NOTIFICATION": "Notification",
  "doc.type.DECLARATION": "Declaration",
...
const hiTranslations: Translations = {
  "ERR_OTP_RATE_LIMITED": "कृपया नया OTP प्राप्त करने के लिए 60 सेकंड प्रतीक्षा करें।",
  "ERR_OTP_INVALID": "अमान्य या समाप्त OTP",
  "ERR_OTP_MAX_ATTEMPTS": "अधिकतम प्रयास पूरे हुए। कृपया एक नया OTP मांगें।",
  "ERR_OTP_EXPIRED": "OTP समाप्त हो गया है।",
  ...
  "doc.repo.title": "दस्तावेज़ रिपॉजिटरी",
  "doc.repo.subtitle": "हस्ताक्षर-स्थिति ट्रैकिंग के साथ संस्करणित, छेड़छाड़-प्रमाण दस्तावेज़ भंडारण।",
  "doc.uploadDocument": "दस्तावेज़ अपलोड करें",
  "doc.documentId": "दस्तावेज़ आईडी",
  "doc.title": "शीर्षक",
  "doc.actions": "कार्रवाइयां",
  "doc.verifyIntegrity": "अखंडता सत्यापित करें",
  "doc.integrityVerified": "अखंडता सत्यापित",
  "doc.integrityFailed": "अखंडता विफल",
  "doc.signatureStatus": "हस्ताक्षर की स्थिति",
  "doc.versionHistory": "संस्करण इतिहास",
  "doc.uploadFailed": "अपलोड विफल",
  "doc.unauthorized": "अनधिकृत",
  "doc.archive": "पुरालेख",
  "doc.search": "खोजें",
  "doc.filter": "फ़िल्टर",
  "doc.documentInfo": "दस्तावेज़ जानकारी",
  "doc.uploadedAt": "अपलोड किया गया",
  "doc.sha256": "SHA-256 चेकसम",
  "doc.linkages": "लिंकेज",
  "doc.project": "परियोजना",
  "doc.parcel": "पार्सल",
  "doc.ulpin": "ULPIN",
  "doc.rnrCase": "R&R केस",
  "doc.compensation": "मुआवजा",
  "doc.statusAndVerification": "स्थिति और सत्यापन",
  "doc.integrityStatus": "अखंडता की स्थिति",
  "doc.tamperingDetected": "भौतिक फ़ाइल हैश डेटाबेस रिकॉर्ड से मेल नहीं खाता है। छेड़छाड़ का पता चला।",
  "doc.digitalSignature": "डिजिटल हस्ताक्षर",
  "doc.cryptoSignatureUnavailable": "प्रोटोटाइप में क्रिप्टोग्राफ़िक रूप से सत्यापित डिजिटल हस्ताक्षर उपलब्ध नहीं है। (रनटाइम/डेमो दृढ़ता)",
  "doc.downloadFile": "फ़ाइल डाउनलोड करें",
  "doc.previewBrowser": "पूर्वावलोकन (ब्राउज़र)",
  "doc.uploadNewVersion": "नया संस्करण अपलोड करें",
  "doc.current": "वर्तमान",
  "doc.noOlderVersions": "कोई पुराना संस्करण नहीं।",
  "doc.selectFile": "अपलोड करने के लिए एक फ़ाइल चुनें",
  "doc.chooseFile": "फ़ाइल चुनें",
  "doc.titleRequired": "शीर्षक *",
  "doc.typeRequired": "प्रकार *",
  "doc.projectIdRequired": "परियोजना आईडी *",
  "doc.parcelIdOptional": "पार्सल आईडी (वैकल्पिक)",
  "doc.ulpinOptional": "ULPIN (वैकल्पिक)",
  "doc.remarksOptional": "टिप्पणियाँ (वैकल्पिक)",
  "doc.submitUpload": "अपलोड सबमिट करें",
  "doc.allTypes": "सभी प्रकार",
  "doc.allStatuses": "सभी स्थितियां",
  "doc.type.NOTIFICATION": "अधिसूचना",
  "doc.type.DECLARATION": "घोषणा",
  "doc.type.AWARD": "पुरस्कार",
  "doc.type.REPORT": "रिपोर्ट",
  "doc.type.RNR": "पुनर्वास",
  "doc.type.OTHER": "अन्य",
  "doc.status.VERIFIED": "सत्यापित",
  "doc.status.PENDING_REVIEW": "समीक्षा लंबित",
  "doc.status.DRAFT": "प्रारूप",
  ...
  "filter.scope": "स्कोप (Scope)",
  "filter.filter": "फ़िल्टर",
  "sync.connectionStatus": "कनेक्शन की स्थिति",
  "sync.status": "स्थिति:",
  "sync.lastSync": "अंतिम सिंक:",
  "sync.autoUpdate": "ऑटो-अपडेट:",
  "sync.enabled": "सक्रिय",
  "sync.reconnect": "पुनः कनेक्ट करें",
