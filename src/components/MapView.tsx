...
export function MapView({ setActiveTab, profile, selectedState, setSelectedState, selectedDistrict, setSelectedDistrict, searchQuery, setSearchQuery, selectedProject, setSelectedProject, selectedStage, setSelectedStage, selectedCategory, setSelectedCategory, selectedRisk, setSelectedRisk }: any) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full w-full min-h-0 relative">
      ...
      <div className="flex flex-1 min-h-0 relative z-10">
        <GISMap setActiveTab={setActiveTab} showSidebar={true} profile={profile} selectedState={selectedState} selectedDistrict={selectedDistrict} searchQuery={searchQuery} selectedProject={selectedProject} setSelectedProject={setSelectedProject} selectedStage={selectedStage} selectedCategory={selectedCategory} selectedRisk={selectedRisk} />
      </div>
    </div>
  );
}
